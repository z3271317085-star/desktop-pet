Create Codex pet row `jumping` for `jiruxue`: exactly 5 full-body frames in one horizontal strip on flat pure green #00FF00.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Ji Ruxue from Chinese anime Buliangren with short black bob hair and asymmetrical blue Wuxia dress. Preserve silhouette, face, palette, material, proportions, markings, and props.
